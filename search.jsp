...
out.println("<header><h2>실습을 환영합니다</h2></header>");
 out.println("<nav><ul>");
 out.println("<li><a href=\"http://jsp.dju.ac.kr/~s20141521/login.html\">로그인</a></li>");
 out.println("<li><a href=\"http://jsp.dju.ac.kr/~s20141521/member.jsp\">회원가입</a></li>");
 out.println("</ul></nav>");
 out.println("<section>");
 ...
 out.println("<header><h2>실습을 환영합니다</h2> </header>");
 out.println("<nav><ul>");
 out.println("<li><a href=\"http://jsp.dju.ac.kr/~s20141521/search.jsp\">회원검색</a></li>");
 out.println("<li><a href=\"http://jsp.dju.ac.kr/~s20141521/logout.jsp\">로그아웃</a></li>");
 out.println("</ul></nav>");
 out.println("<section>");
 ...
 out.println("</select>");
 out.println("<input id=\"id_forml\" type=\"text\" name=\"stud_search\" size=\"20\" maxlength=\"50\"/>");
 out.println("<input type=\"submit\" value=\"검색\">");
 out.println("</fieldset>");
 out.println("</form>");
 out.println("</section>");
 out.println("<footer><p>&copy;2016 Made by Korea. All rights reserved.</p></footer>");
}
%>
 </body></html>
